// Importar el tipo FilaTabla del backend
export type { FilaTabla } from "@/services/simulacion";

// StateVectorRow ahora es un alias de FilaTabla para mantener compatibilidad
import type { FilaTabla } from "@/services/simulacion";
export type StateVectorRow = FilaTabla;
